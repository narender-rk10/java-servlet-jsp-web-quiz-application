<%-- 
    ...
    Created on : Sep 6, 2019, 7:17:00 PM
    Author     : narender
--%>
...
<html>
    <head>
        ...
        <title>SHOW FEEDBACK OF USERS</title>
  <style>
  body {
...
table {
 ...
 <img class="logo-img" src="l1.jpeg" width="230" height="145" ALT="align box">
            ...
            <center>
                <div><center><br><br>
                        <h4>SEE YOUR USER'S FEEDBACK WHAT THINKING ABOUT THE SYSTEM?</h4>
         <table border="1">
                  <tr><th>ID</th><th>NAME</th><th>MOBILE NUMBER</th><th>EMAIL ADDRESS</th><th>FEEDBACK</th></tr>
        <%  Class.forName("com.mysql.jdbc.Driver");
         ...
         %>
           <tr><td><%=id%></td><td><%=n%></td><td><%=p%></td><td><%=e%></td><td><%=fb%></td><tr>
          <% } %>
            </table>
            </center>
        </div>
