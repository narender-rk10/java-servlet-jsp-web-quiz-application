<%-- 
    Document   : UpdateMProcess
    Created on : Sep 6, 2019, 1:56:33 AM
    Author     : narender
--%>
...
table {
 ...
 <img class="logo-img" src="l1.jpeg" width="230" height="145" ALT="align box">
       ...
       <%   String bid=request.getParameter("id");
            ...
            String query = "select * from "+a+" where q_id='"+bid+"'";
            ...
            %>
                ...
                <tr><th>Question No.</th><th>Question</th></tr>
                <tr><th><input type="text"  name="qid" value="<%= qid %>" ></th>
                <td><input type="text" name="question" value="<%= b %>"></td></tr>
                <tr><th>A:</th><td><input type="text" name="o1" value="<%= c %>"></td></tr>
                <tr><th>B:</th><td><input type="text" name="o2" value="<%= d %>"></td></tr>
                <tr><th>C:</th><td><input type="text" name="o3" value="<%= e %>"></td></tr>
                <tr><th>D:</th><td><input type="text" name="o4" value="<%= f %>"></td></tr>
                <tr><th>CORRECT ANSWER:</th><td><input type="text" name="cans" value="<%= g %>"></td></tr><br><br>
                </table></center><br><br>
                <center><input type="submit" value="UPDATE YOUR QUESTIONS" <a href="UpdateController?qid=<%=rs.getString(1)%>"></a></center>
              <%   } %>
                 </div></center>
                </form>
   <footer>
